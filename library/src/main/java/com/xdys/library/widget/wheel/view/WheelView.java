package com.xdys.library.widget.wheel.view;
...
import com.xdys.library.widget.wheel.listener.LoopViewGestureListener;
import com.xdys.library.widget.wheel.listener.OnItemSelectedListener;
import com.xdys.library.widget.wheel.timer.InertiaTimerTask;
import com.xdys.library.widget.wheel.timer.MessageHandler;
import com.xdys.library.widget.wheel.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private boolean isAlphaGradient = true; //透明度渐变
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 20, getContext().getResources().getDisplayMetrics()
        );
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.WheelView_wheel_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.WheelView_wheel_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.WheelView_wheel_dividerColor, 0xFFd5d5d5);
            dividerWidth = a.getDimensionPixelSize(R.styleable.WheelView_wheel_dividerWidth, 2);
            textSize = a.getDimensionPixelOffset(R.styleable.WheelView_wheel_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.WheelView_wheel_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < adapter.getItemsCount(); i++) {
            String s1 = getContentText(adapter.getItem(i).toString());
